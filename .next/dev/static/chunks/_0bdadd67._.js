...
function SummaryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SummaryPage.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://127.0.0.1:5000/api/video/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            }).then({
                "SummaryPage.useEffect": (res)=>setVideo(res.data)
            }["SummaryPage.useEffect"]).catch({
                "SummaryPage.useEffect": ()=>alert("Failed to load summary")
            }["SummaryPage.useEffect"]).finally({
                "SummaryPage.useEffect": ()=>setLoading(false)
            }["SummaryPage.useEffect"]);
        }
    }["SummaryPage.useEffect"], [
        id
...
_s(SummaryPage, "eGJstd614cAZUlob/28H2hIXQzc=", false, function() {
    return [
...
//# sourceMappingURL=_0bdadd67._.js.map